...
public class ConnectionPool {
		...
		public static void initialize() {						
			try {
				...
				poolProp.setUrl("jdbc:mysql://localhost/edutechonline?autoReconnect=true&amp;zeroDateTimeBehavior=convertToNull");								// URL to the database we want to use
				poolProp.setDriverClassName("com.mysql.jdbc.Driver");				// We're using the JDBC driver
				poolProp.setUsername("root");								// Database username
				poolProp.setPassword("ceufpxj1");							// Database password for the given username
